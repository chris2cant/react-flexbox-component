...
var media = Object.keys(sizes).reduce(function (acc, label) {
  acc[label] = function () {
    return styled.css(_templateObject, sizes[label] / 16, styled.css.apply(undefined, arguments));
  };

  return acc;
}, {});

var Content = styled__default.div(_templateObject2, function (props) {
...
var ItemStyled = styled__default(Flex)(_templateObject4$1, function (props) {
  return props.xRay ? "lightgreen" : null;
}, function (props) {
  return props.align;
});

var ColumnStyled = styled__default(Flex)(_templateObject5$1, function (props) {
...
var RowStyled = styled__default(Flex)(_templateObject6$1, function (props) {
